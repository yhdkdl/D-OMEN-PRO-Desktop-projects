<?php
session_start();
define("BASE_PATH", __DIR__ . "/../Actors");
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <a href="#" class="brand-link">
        <span class="brand-text font-weight-light">TH Movie Ticket System</span>
      </a>
        ...
        <div class="container-fluid">
          ...
          if (isset($_GET['page'])) {
              switch ($_GET['page']) {
                  case 'Manage-employe':
                      if ($userRole === 'Admin') {
                        include BASE_PATH . '/Admin/employee_list.php'; 
                      } else {
                  ...
                  case 'add-theaters':
                      if ($userRole === 'Admin') {
                          include BASE_PATH . '/Admin/theater.php';
                      } else {
                          echo "<h2>Access Denied</h2>";
                      }
                      break;
                  case 'feedback':
                      if ($userRole === 'Admin') {
                          include BASE_PATH . '/Admin/feedback.php';
                      } else {
                          echo "<h2>Access Denied</h2>";
                      }
                      break;
